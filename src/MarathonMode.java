...
public class MarathonMode extends GameplayScreen{
    ...
    public MarathonMode(GameTesting gameTesting, Screen previous, Player user, Country correctCountry, Country incorrect1, Country incorrect2) throws IOException {
    ...
    public void setComponents(){
        ...
        resizedEmptyHeartIMG = fullHeartIMG.getScaledInstance(width/20, height/20, Image.SCALE_SMOOTH);
